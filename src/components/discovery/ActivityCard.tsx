    ...
    <div className="glass-card card-25d" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column', background: 'var(--bg-card)' }}>
      <div className="card-25d-inner" style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        <div style={{ position: 'relative', height: '165px', overflow: 'hidden' }}>
          <img src={activity.coverImage} alt={activity.name} style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.5s ease' }} />
          <div style={{
            position: 'absolute',
            inset: 0,
        ...
        <div style={{ padding: '1rem', display: 'flex', flexDirection: 'column', gap: '0.6rem', flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', color: 'var(--accent-champagne)', fontWeight: 600 }}>
              <Star size={14} fill="var(--accent-champagne)" /> {activity.rating}
            </span>
          </div>
